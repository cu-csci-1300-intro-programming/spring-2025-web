...
&nbsp;&nbsp;&nbsp;&nbsp;
## PreQuiz
Answer each of the following questions in your own words. Upload your responses to Canvas using the available text box. Be sure to label your answers.

### PreQuiz Problem 1
What is the difference between arithmetic and relational operators?

### PreQuiz Problem 2
What is the correct way to write a condition to determine if a variable `num` stores a number between 0 and 4, inclusive?
...
### PreQuiz Problem 4
Complete the following truth table to evaluate the expressions for `(a && !b)`. Write the full word `true`, or `false`.
...
### PreQuiz Problem 5
Complete the following truth table to evaluate the expressions for `(a || (!a \&\& b))`. Write the full word `true`, or `false`
