...
\begin{enumerate}
    ...
    \item Create a zip file submission
...
\includegraphics[width=\textwidth]{windows_zip.png}
...
After which it will produce a file which looks like so:
...
\includegraphics[width=\textwidth]{images/csel_finalzip.png}
